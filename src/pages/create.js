...
const Create = () => {
	...
	return (
		<div className="create">
			...
			<div>
				<div>
					<form encType="multipart/form-data" className="upload position-relative" onSubmit={uploadImage}>
						{currentState === "upload" ? (
							<>
								...
								<div>
									{!imgPreview ? (
										<p className="text-center">
											By submitting your photos to aworan you acknowledge that you agree to (insert name )Terms of Service and Community Guidelines. <br /> Please be sure not to violate others'
						...
						{currentState === "preview" || imgPreview ? (
							<>
								...
								<div className="position-absolute text-end w-100 bottom-0 px-5">
									<button type="button" className="bg-white border-0 round-ter p-3 px-5 me-md-5 mb-4 mb-md-0 d-blue-sec" onClick={() => setPreview("")} disabled={loading}>
										Back
									</button>
									<button type="submit" className="d-bg-blue border-0 px-5 text-wite round-ter p-3 text-white" disabled={loading}>
										Proceed
									</button>
								</div>
							</>
					...
					{currentState === "success" ? (
						<div className="success">
							...
							<p className="text-center">Your photo is under review,once approved you’d be notified</p>
							<div className="text-center amt-6">
								<button className="d-bg-blue border-0 px-5 text-wite round-ter p-3 text-white me-md-5 mb-4 mb-md-0" onClick={() => setCurrentState("upload")}>
									Create another
								</button>
